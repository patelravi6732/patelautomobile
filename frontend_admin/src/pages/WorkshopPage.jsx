...
export default function WorkshopPage() {
  ...
  const handleFinishBill = async (e) => {
    ...
    // 1. Update workshop data only after a successful server completion (or an offline fallback).
    ...
    // 2. The completed booking, billing and customer details now all follow the same finished bill.
    ...
    if (offlineCompletion) {
      ...
      // Khata Book reads the pending amount from this server invoice, so it stays in sync without a duplicate debit.
