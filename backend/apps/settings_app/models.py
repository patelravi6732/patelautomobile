...
class GarageSettings(models.Model):
    ...
    mechanics_list = models.TextField(default="Unassigned, Amitbhai Mechanic, Vishalbhai Mechanic, Manojbhai Mechanic")
    default_labour_charge = models.DecimalField(max_digits=10, decimal_places=2, default=100.00)
